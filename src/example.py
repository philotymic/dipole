...
class Callback(_object):
    ...
    def run(self, n):
        return _example.Callback_run(self, n)
...
def doSomeWithCallback():
    return _example.doSomeWithCallback()
doSomeWithCallback = _example.doSomeWithCallback

def setCallback(cb):
    return _example.setCallback(cb)
setCallback = _example.setCallback
